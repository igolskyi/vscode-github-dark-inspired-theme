...
function getTheme({ theme, name }) {
  ...
  return {
    ...
    colors: {
      ...
      "activityBar.foreground"        : themes({ dark: "#FFFFFF", light: color.fg.default }),
      "activityBar.inactiveForeground": themes({ dark: "#6272A4", light: color.fg.muted }),
      "activityBar.background"        : themes({ dark: "#0D1117", light: color.canvas.default }),
      "activityBarBadge.foreground"   : themes({ dark: "#000000", light: color.fg.onEmphasis }),
      "activityBarBadge.background"   : themes({ dark: "#2ec27e", light: color.accent.emphasis }),
      "activityBar.activeBorder"      : themes({ dark: "#7EE787", light: color.primer.border.active }),
      ...
      "tree.indentGuidesStroke": themes({ dark: "#6272A460", light: color.border.muted }),
      ...
      "tab.hoverBorder"             : themes({ dark: "#2ec27e", light: color.canvas.default }),
      ...
      "tab.activeBorderTop"         : themes({ dark: "#00ff00", light: color.primer.border.active }),

      "sash.hoverBorder"            : themes({ dark: "#2ec27e", light: color.primer.border.active }),
    ...
    tokenColors: [
      {
        ...
        settings: {
          foreground: themes({ dark: "#6272A4", light: scale.gray[5] })
        },
      },
      {
        scope: [
      ...
      },
      {
        ...
        settings: {
          foreground: themes({ dark: "#FFFFFF", light: scale.blue[6] })
        },
      },
      {
        scope: [
      ...
      },
      {
        ...
        settings: {
          foreground: themes({ dark: "#FF79C6", light: scale.green[6] })
        },
      },
      {
        "scope": "entity.name.tag.body.css",
        settings: {
          foreground: themes({ dark: "#74D4FF", light: scale.green[6] })
        },
      },
      {
        scope: "keyword",
      ...
      },
      {
        ...
        settings: {
          foreground: themes({ dark: "#85E89D", light: scale.blue[8] })
        },
      },
      {
        scope: "support",
      ...
      },
      {
        ...
        settings: {
          foreground: themes({ dark: "#79B8FF", light: scale.green[6] })
        },
      },
      {
      ...
      },
      {
        ...
        settings: {
          foreground: themes({ dark: "#FF7B72", light: scale.red[5] })
        },
      },
      {
        scope: [
      ...
      },
      {
        ...
        settings: {
          foreground: themes({ dark: "#9ECBFF", light: scale.blue[6] })
        },
      },
      {
        scope: [
        ...
        settings: {
          foreground: themes({ dark: "#D2A8FF", light: scale.purple[5] })
        },
      },
    ],
  };
